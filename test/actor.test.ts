...
describe('Actor game test suite', () => {
    ...
    test('Init line should create a valid line structure', () => {
        const line = A.init_line(60, 5, 0, 1);
    ...
    test('Init line should preserve the ordinate value', () => {
        const line1 = A.init_line(10, 1, 0, 1);
        const line2 = A.init_line(10, 5, 0, 1);
        const line3 = A.init_line(10, 10, 0, 1);
    ...
    test('Init line should handle different sizes', () => {
        const line1 = A.init_line(5, 1, 0, 1);
        const line2 = A.init_line(15, 1, 0, 1);
        const line3 = A.init_line(20, 1, 0, 1);
